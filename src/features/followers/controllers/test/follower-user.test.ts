...
describe('Add', () => {
  ...
  describe('follower', () => {
    it('should call updateFollowerCountInCache', async () => {
      ...
      expect(FollowerCache.prototype.updateFollowerCountInCache).toHaveBeenCalledWith('6064861bc25eaa5a5d2f9bf4', 'followersCount', 1);
      expect(FollowerCache.prototype.updateFollowerCountInCache).toHaveBeenCalledWith(`${existingUser._id}`, 'followingCount', 1);
